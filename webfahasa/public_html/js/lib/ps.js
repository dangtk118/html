var PrivateSecure=function(t){this.k=[],this.init=function(t){this.k=t},this.getHeader=function(){let t=SESSION_ID,i=Intl.DateTimeFormat().resolvedOptions().timeZone;var e=Math.round((new Date).getTime()/1e3);return{hs:this.getPs(t+e),t:e,tz:i}},this.getPs=function(t){let i=t,e=this.gH();return CryptoJS.MD5(i+e).toString()},this.gH=function(){var t="";for(let i=0;i<this.k.length;i++)t+=String.fromCharCode(this.k[i]-(Math.pow(2,14)<<1));return t},this.getChar=function(t){return String.fromCharCode(97+t)},this.getCookie=function(t){const i=`; ${document.cookie}`.split(`; ${t}=`);if(2===i.length)return i.pop().split(";").shift()},this.init(t)};

var CryptoJS = CryptoJS || function (s, p) {
    var m = {}, l = m.lib = {}, n = function () {}, r = l.Base = {extend: function (b) {
            n.prototype = this;
            var h = new n;
            b && h.mixIn(b);
