...
class Common{ 
	...
	public static function callRest($aConfig, $aData)
	{
		...
		{	
			...
			$aData['checksum'] = $sign;
                        Mage::log("*** 123Pay Master callRest - callRest model checksum: " . $aData['checksum'], null, "123pay.log");
			...
			return $rs;
                        ...
                        Mage::log("*** 123Pay Master Model - callRest Exception", null, "123pay.log");
                        Mage::log("*** 123Pay Master Model - callRest Exception1:" . $fault->getTraceAsString(), null, "123pay.log");
                        Mage::log("*** 123Pay Master Model - callRest Exception2:" . $fault, null, "123pay.log");
			throw $fault;
		}
	}
}
