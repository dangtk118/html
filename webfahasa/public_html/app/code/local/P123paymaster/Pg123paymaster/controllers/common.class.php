...
class Common{ 
	...
	public static function callRest($aConfig, $aData)
	{
		...
		{	
			...
			$aData['checksum'] = $sign;
                        Mage::log("*** 123Pay Master callRest - controller aConfig: " . print_r($aConfig, true) , null, "123pay.log");
                        Mage::log("*** 123Pay Master callRest - controller aData: " . print_r($aData, true) , null, "123pay.log");
                        Mage::log("*** 123Pay Master callRest - callRest controller checksum: " . $aData['checksum'], null, "123pay.log");
			...
			return $rs;
                        ...
                        Mage::log("*** 123Pay Master controllers - callRest Exception", null, "123pay.log");
                        Mage::log("*** 123Pay Master controllers - callRest Exception1: " . $fault->getTraceAsString(), null, "123pay.log");
                        Mage::log("*** 123Pay Master controllers - callRest Exception2: " . $fault, null, "123pay.log");
			throw $fault;
		}
	}
}
