...
class Magestore_Fblogin_IndexController extends Mage_Core_Controller_Front_Action {
    ...
    public function indexAction() {
        ...
        if (!$customer || !$customer->getId()) {
            ...
            //successfully create new account via facebook. Dispatch event here
    ...
    /**
     * Dispatch event fhs_success_register_after_save, after successfully create
     * accunt via facebook
     * @param type $customer
     */
    ...
    {        
        ...
        Mage::dispatchEvent('fhs_success_register_after_save',
            array('controller' => $this, 'customer' => $customer, 'type' => 'facebook')
        );
    }
