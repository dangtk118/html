    ...
    extends Mage_SalesRule_Model_Rule_Condition_Product_Combine
{
    ...
    {
	//Trung: fix as suggested here: http://magento.stackexchange.com/questions/53777/magento-enterprise-1-14-1-0-shopping-cart-price-rules-promotion-fatal-erro
...
//        $this->setAggregator(join('/', $aggregatorArr))->setValue($value);
        ...
        return $this->validateAttribute($total, $all, $true);
    }
}
