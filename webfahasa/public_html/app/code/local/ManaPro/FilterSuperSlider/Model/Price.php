 ...
 *
 */
class ManaPro_FilterSuperSlider_Model_Price extends Mana_Filters_Model_Filter_Price {
    /**
...
//        $toPrice    = $helper->formatNumber($range['to'], $this->getFilterOptions());
        $fromPrice = number_format($range['from'], 0, ".", ",");
        $toPrice = number_format($range['to'], 0, ".", ",");
