 ...
 */
class Fahasa_Coreextended_Block_Helper extends Mage_Review_Block_Helper
{
    protected $_availableTemplates = array(
        'default' => 'review/helper/summary.phtml',
        'short'   => 'review/helper/summary_short.phtml',
        'fahasa'  => 'review/helper/summary_fahasa.phtml'
    );
    protected $templateType = "tabslider/review.phtml";
    
    public function getFhsReviewSummary($product){                
