...
class Ves_Megamenu_Helper_Media extends Mage_Core_Helper_Abstract {
    ...
    function addMediaFile($type = "", $source = "", $before = false, $params = null, $if = "", $cond = "") {
     ...
     public function loadMedia(){               
        $this->addMediaFile("js", "venustheme/ves_megamenu/jquery/jquerycookie.js", true);
        $this->addMediaFile("js", "venustheme/ves_megamenu/admin/megamenu/jquery.nestable.js", true);
        $this->addMediaFile("js", "venustheme/ves_megamenu/jquery/tabs.js", true);
        $this->addMediaFile("js", "venustheme/ves_megamenu/jquery/ui/jquery-ui-1.8.16.custom.min.js", true);
        $this->addMediaFile("js", "venustheme/ves_megamenu/jquery/conflict.js", true);
        $this->addMediaFile("js", "venustheme/ves_megamenu/jquery/jquery-1.7.1.min.js", true);
