...
class Ves_Verticalmenu_Model_Widget extends Mage_Core_Model_Abstract
{
	...
	private $widgets = array();
        private static $widgetCollection = null;
	...
	public function loadWidgets(){            
		if( empty($this->widgets) ){
                        if (self::$widgetCollection == null) {                            
                            self::$widgetCollection = $this->getCollection();
                        }
			foreach(self::$widgetCollection as $widget ){
	...
	protected function renderLayoutHtml( $layout, $data = array() ) {
		...
		$templatePath = 'ves' . DS . 'verticalmenu'.DS.'widgets'.DS.$layout.$custom_layout.'.phtml';
