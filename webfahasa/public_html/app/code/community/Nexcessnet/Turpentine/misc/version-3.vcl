...
sub vcl_deliver {
    ...
    std.log("BPC2Referrer:" + regsub(regsub(req.http.Cookie, ".*BPC2Referrer=", ""), ";.*$", ""));
    std.log("sessionid:" + regsub(regsub(req.http.Cookie, ".*frontend=", ""), ";.*$", ""));
    std.log("utmz:" + regsub(regsub(req.http.Cookie, ".*__utmz=", ""), ";.*$", ""));
}
