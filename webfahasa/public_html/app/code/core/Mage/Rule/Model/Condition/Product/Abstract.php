...
//            return $this->validateAttribute($object->getCategoryIds(), $all, $true);
            
            //vannguyen: prevent loop query category for each product in cart
            $product_category_ids = array_filter(array(
                $object['category_main_id'],
                $object['category_mid_id'],
                $object['category_1_id'],
                $object['cat4_id'],
            ),function($e){
                return $e != 1;
            });
            return $this->validateAttribute($product_category_ids, $all, $true);
            ...
            if ($attr && $attr->getBackendType() == 'datetime' && !is_int($this->getValue())) {
                ...
                return $this->validateAttribute($value, $all, $true);
            }
