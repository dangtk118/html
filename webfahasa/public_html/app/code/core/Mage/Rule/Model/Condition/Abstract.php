...
//        ));
     ...
     * @return  bool
     */
    public function validateAttribute($validatedValue, $all = false, $true = false)
    {
	...
	//get validate msg
	Mage::dispatchEvent('rule_validate', 
	    array('rule_id'=>$this->getRule()->getRuleId(),
		    'result'=>$result,
		    'all'=>$all,
		    'true'=>$true,
		    'attribute'=>$this->getAttribute(),
    ...
    {
        return $this->validateAttribute($object->getData($this->getAttribute()), $all, $true);
    }
