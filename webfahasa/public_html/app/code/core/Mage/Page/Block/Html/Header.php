...
class Mage_Page_Block_Html_Header extends Mage_Core_Block_Template
{
    ...
    public function getLogoSrcSecond()
    {
        return $this->getSkinUrl('images/fahasa-logo.png');
    }
	...
	$result = $cache_helper->getData($key);
	if(empty($result)){
	    $result = $this->getChildHtml('topMenu');
	    $cache_helper->setData($key, $result);
	}
	return $result;
    }
}
