...
class Mage_Shipping_Model_Shipping
{
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
	    ...
	    //get and set Expected Delivery to session
	    //Mage::getSingleton('customer/session')->getExpectedDelivery()
	    Mage::helper('onestepcheckout')->getExpectedDeliveryInCart($request);
