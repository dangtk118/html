...
class Mage_Core_Model_Config extends Mage_Core_Model_Config_Base
{
    ...
    public function init($options=array())
    {
        ...
        // Trung: https://github.com/AmpersandHQ/magento-ce-ee-config-corruption-bug#the-problem
...
//            Mage::log("get Model instance  --- " . $time, null, "time.log");
            return $obj;
        } else {
            return false;
        }
 ...
 $time_end = microtime(true);
                $time = $time_end - $time_start;
//                  Mage::log("Time get resouce model class name *********  --- " . $time_end . " - " . $time, null, "rediscart.log");
