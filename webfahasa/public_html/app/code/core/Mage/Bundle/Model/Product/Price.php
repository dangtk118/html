...
class Mage_Bundle_Model_Product_Price extends Mage_Catalog_Model_Product_Type_Price
{
    ...
    protected function _getSelectionPrices($product, $option, $takeTierPrice, $includeTax)
    {
        ...
        foreach ($selections as $selection) {
            ...
            if (!$selection->isSalable()) {
                 ...
                 */
                /*
                 *  We want to show combo with items that are out of stock
                 */
                //continue;
            }
    ...
    public function getOptions($product)
    {
        ...
        /*
         *  NOTE: last argument is false by default (appendAll = false)
         *  but now we want to include item price (out of stock) when display combo price
         */
        return $optionCollection->appendSelections($selectionCollection, false, true);
    }
