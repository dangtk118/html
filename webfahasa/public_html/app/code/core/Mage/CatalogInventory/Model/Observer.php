...
class Mage_CatalogInventory_Model_Observer
{
    ...
    public function subtractQuoteInventory(Varien_Event_Observer $observer)
    {
        ...
        //use for book festival -> do not substract stock_qty
        if (Mage::app()->getStore()->getStoreId() == Mage::getStoreConfig('book_festival/config/store_code')){
            return;
        }
        ...
        $this->_itemsForReindex = Mage::getSingleton('cataloginventory/stock')->registerProductsSale($items, $quote);
    ...
    public function reindexQuoteInventory($observer)
    {
        ...
        //Trung: disable the price reindex to resolve
        //       db deadlock in case of a lot of checkout.
        //       This may break tiered promo rules,
        //       but Fahasa is not using it anyway.
