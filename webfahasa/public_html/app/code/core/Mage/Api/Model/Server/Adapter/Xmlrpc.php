    ...
    implements Mage_Api_Model_Server_Adapter_Interface
{
    ...
    {
        Mage::log("Mage_Api_Model_Server_Adapter_Xmlrpc 1", null, "soap.log");
    ...
    {
        Mage::log("Mage_Api_Model_Server_Adapter_Xmlrpc 2", null, "soap.log");
    ...
    {
        Mage::log("Mage_Api_Model_Server_Adapter_Xmlrpc 3", null, "soap.log");
    ...
    {
        Mage::log("Mage_Api_Model_Server_Adapter_Xmlrpc 4", null, "soap.log");
    ...
    public function run()
    {
        Mage::log("Mage_Api_Model_Server_Adapter_Xmlrpc 5", null, "soap.log");
    ...
    {
        Mage::log("Mage_Api_Model_Server_Adapter_Xmlrpc 6", null, "soap.log");
