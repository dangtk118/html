    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        if (!$model->getId()) {
            ...
            $model->setData('created_team', 'MKT');
        }
        ...
        $fieldset->addField('auto_add_gift', 'select', array(
            'label'     => Mage::helper('salesrule')->__('Auto add gift'),
            'title'     => Mage::helper('salesrule')->__('Auto add gift'),
            'name'      => 'auto_add_gift',
            'values'    => Mage::getSingleton('adminhtml/system_config_source_yesno')->toOptionArray(),
        ));
	
        $fieldset->addField('from_created_account', 'date', array(
            'name'   => 'from_created_account',
            'label'  => Mage::helper('salesrule')->__('Account created from'),
            'title'  => Mage::helper('salesrule')->__('Account created from'),
            'image'  => $this->getSkinUrl('images/grid-cal.gif'),
            'input_format' => Varien_Date::DATE_INTERNAL_FORMAT,
            'format'       => $dateFormatIso
        ));
	
        $fieldset->addField('created_team', 'select', array(
            'label'     => Mage::helper('salesrule')->__('Created team'),
            'title'     => Mage::helper('salesrule')->__('Created team'),
            'name'      => 'created_team',
            'required' => false,
            'options'    => array(
                '' => Mage::helper('salesrule')->__('None'),
                'MKT' => Mage::helper('salesrule')->__('Marketing'),
                'PARTNERSHIP' => Mage::helper('salesrule')->__('Partnership'),
		'KD' => Mage::helper('salesrule')->__('Kinh doanh'),
                'CSKH' => Mage::helper('salesrule')->__('CSKH'),
                'VHDT' => Mage::helper('salesrule')->__('Van hanh doi tac'),
            ),
        ));
