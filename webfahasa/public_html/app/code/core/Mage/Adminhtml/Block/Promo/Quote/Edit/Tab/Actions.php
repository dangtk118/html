    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('max_discount_fee', 'text', array(
            'name' => 'max_discount_fee',
            'label' => Mage::helper('salesrule')->__('Maximum Discount Fee'),
        ));
        $model->setMaxDiscountFee($model->getMaxDiscountFee()*1);
