...
abstract class Mage_Catalog_Block_Layer_Filter_Abstract extends Mage_Core_Block_Template
{
     ...
     */
    public function init($load_param = true)
    {
        $this->_initFilter($load_param);
        return $this;
    }
     ...
     * @return Mage_Catalog_Block_Layer_Filter_Abstract
     */
    protected function _initFilter($load_param = true)
    {
        ...
        $this->_filter->apply($this->getRequest(), $this, $load_param);
        return $this;
    }
