...
class Mage_Catalog_Block_Product_View_Media extends Mage_Catalog_Block_Product_View_Abstract
{
     ...
     */
    public function getGalleryImages($_product = null)
    {
    ...
    public function mediaItemStyle($current_number_image, $current_number_video, $limit, $item_count){
	$result = '';
	$item_count = $current_number_image + $current_number_video;
