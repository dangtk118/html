...
class Mage_Catalog_Model_Url
{
	...
	if(!empty($product->getSeriesId()) && $product->getTypeId() == "series"){
	    if(!empty($product->getUrlCustom())){
		return $product->getUrlCustom();
	    }
	    if(!empty($product->getSeriesId())){
		return 'seriesbook/index/series/id/' . $product->getSeriesId();
	    }
	}
