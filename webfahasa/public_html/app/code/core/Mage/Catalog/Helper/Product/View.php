...
//	$design = Mage::getSingleton('catalog/design');
        $design = Mage::helper('fahasa_catalog');
...
//        $update->addHandle('PRODUCT_' . $product->getId());
        $update->addHandle('PRODUCT_TYPE_' . $product['entity_id']);
        $update->addHandle('PRODUCT_' . $product['entity_id']);
        ...
        if ($root) {
            ...
            $root->addBodyClass('product-' . 'chai-metallic-poster-paint-300ml-dong-233tm300930-primo');
...
//        $productHelper = Mage::helper('catalog/product');
        $productHelper = Mage::helper('fahasa_catalog');
        if (!$params) {
...
//        --event catalog_controller_product_view(ViewProduct) has been call in getInfoProductID in helper catalog;  
...
//        }
        ...
        Mage::getSingleton('catalog/session')->setLastViewedProductId($product['entity_id']);
