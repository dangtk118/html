...
//            if ($netcore_enable == 1){
//                $netcore = $this->_getCustomerSession()->getNetcore();
//                if(!$netcore){
//                    $netcore = "";
//                }
//                foreach ($this->_getCart()->getQuote()->getAllVisibleItems() as $item): 
//		    if($item){
...
//            }
	    Mage::register('is_gat_customer_info_rest', true);
            ...
            $this->_getSession()->setCartWasUpdated(true);
//            if ($netcore_enable == 1){
//                $this->_getCustomerSession()->setNetcore($netcore);
//            }
...
//                    if ($netcore_enable == 1 || $enhanced_ecom_enable == 1){
...
//                        $enhanced_ecom = $this->_getCustomerSession()->getEnhancedEcom();
//                        if(!$enhanced_ecom){
//                            $enhanced_ecom = "";
//                        }
//                        if ($item){
...
//                    }
//                    if ($enhanced_ecom_enable == 1){
//                        $this->_getCustomerSession()->setEnhancedEcom($enhanced_ecom);
//                    }
                } catch (Exception $e) {
