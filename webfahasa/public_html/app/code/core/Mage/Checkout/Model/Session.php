        ...
        if ($this->_quote === null) {
            ...
            if ($this->getQuoteId()) {
                ...
                if ($quote->getId()) {
                     ...
                     * store switcher.
                     */
                    //the second condition is used: if customer switch store id -> maybe price in each store are different
                    if ($quote->getQuoteCurrencyCode() != Mage::app()->getStore()->getCurrentCurrencyCode() 
                            || $quote->getStoreId() != Mage::app()->getStore()->getStoreId()) {
