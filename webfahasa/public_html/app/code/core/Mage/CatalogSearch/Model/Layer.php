...
class Mage_CatalogSearch_Model_Layer extends Mage_Catalog_Model_Layer
{
    ...
    public function getProductCollection()
    {
	    ...
	    if(!$collection->_addSubscribes){
		 $collection->getSelect()->joinLeft(array('sed' => 'fahasa_seribook_extra_data'), 'sed.seriesset_id = e.entity_id',array('subscribes','label'));
    
		$collection->_addSubscribes = true;
	    }
