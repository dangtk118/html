...
class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
{
    ...
    public function setCustomerAsLoggedIn($customer)
    {
        ...
        if(Mage::getSingleton("core/session")->getEncryptedSessionId() == Mage::getSingleton("core/session")->getSessionId()){
	    Mage::helper('productviewed')->setCustomerLastSessionId($customer->getEntityId(), Mage::getSingleton("core/session")->getEncryptedSessionId());
	}
        return $this;
    }
